...
// A user can configure the amount of time per week they estimate Thunderbird is running on their machine
...
// Selects the next key to refresh, selected at random from all of a user's public keys
